    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">{deptLabel} · {isAdmin ? 'AX팀 통합 관리' : '부서장 관리'}</p>
        </div>
                      ...
                      <tr key={q.id} className={row}>
                        ...
                        <td className="p-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs text-gray-500 whitespace-nowrap">{used} / {q.totalQuota}석</span>
                          </div>
                        </td>
                        <td className="p-4">
                  ...
                  <div key={q.id} className="bg-white rounded-xl shadow-sm overflow-hidden">
                    <div className="px-5 py-3 bg-gray-50 border-b flex items-center justify-between">
                      <div>
                        ...
                        <span className="ml-2 text-xs text-gray-400">{q.department}</span>
                      </div>
                    ...
                    {members.length === 0 ? (
                      <div className="px-5 py-6 text-center text-gray-400 text-sm">배정된 팀원이 없습니다.</div>
                    ) : (
                      <table className="w-full text-sm">
                        <thead className="border-b bg-white">
                          <tr>
                            <th className="text-left p-4 font-medium text-gray-500 text-xs">이름</th>
                            <th className="text-left p-4 font-medium text-gray-500 text-xs">이메일</th>
                            <th className="text-left p-4 font-medium text-gray-500 text-xs">상태</th>
                            <th className="text-left p-4 font-medium text-gray-500 text-xs">배정일</th>
                            <th className="p-4"></th>
                          </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-50">
