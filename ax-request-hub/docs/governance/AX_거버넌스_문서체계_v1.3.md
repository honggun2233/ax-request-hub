...
| AX-REGULATION 제1조·제5조 (등급·상용 확정 권한) | ⬜ 반영 필요 | 데이터 자산 등급 부여 의무, G3 이중 승인, 상용 확정 권한=협의회 → architecture v3 §10·§8 |
| AX-POLICY v4 제22조 (엔지니어 기준) | ✅ 반영 완료 | 제22조 하단 callout → `AX_개발표준_전사AI과제용.md` (커버리지 80% 통일) |
| AX-POLICY v4 제9~10장 (AX위원회) | ⬜ 반영 필요 | 상용 전환 심의 안건 유형·상정 요건 5종·의결 유형 5종 → architecture v3 §8 |
| AX-POLICY v4 제19~27조 (파이프라인·데이터) | ⬜ 반영 필요 | 개발/상용 라이프사이클 분리, 데이터 프로비저닝 절차 → architecture v3 §7·§10 |
| AX-GUIDELINE 제4조 (기본방침) | ✅ 반영 완료 | 5개 원칙 하단 개발자 추가 원칙 → `AX_개발표준_전사AI과제용.md` |
| AX-MANUAL 3단계 (처리 절차) | ✅ 반영 완료 | Gate 2 자가점검 별도 callout 분리 |
| AX-MANUAL-2026-001 (데이터 신청 가이드) | ⬜ 반영 필요 | 카탈로그 검색→신청→제공 실무 가이드 섹션 추가 |
