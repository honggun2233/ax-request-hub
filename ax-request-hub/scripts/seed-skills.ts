...
const SEED_SKILLS = [
  {
    ...
    status: 'active',
    purpose: 'ETF 순자산가치(NAV)와 시장가격 간 괴리를 발견하고 원인을 분석합니다.',
...
...`,
  ...
  },
  {
    ...
    securityLevel: 'PUBLIC',
    status: 'active',
    purpose: '업무 상황을 간단히 입력하면 격식에 맞는 업무 메일 초안을 작성해 줍니다.',
...
---`,
  ...
  },
  {
    ...
    securityLevel: 'PUBLIC',
    status: 'active',
    purpose: '회의 메모나 녹취 텍스트를 구조화된 회의록으로 변환합니다.',
...
- 출력 형태: {집계 방식, 정렬 기준 등}`,
    examples: '',
    cautions: 'G3 등급 데이터(개인정보, 미공개 수익률)는 입력하지 마세요.',
  },
]

async function main() {
  console.log('시드 스킬 등록 시작...')
