...
const FILES = ['규정_AI_거버넌스.md','가이드라인_AI_거버넌스.md'];
const OUT_NAMES = {'규정_AI_거버넌스.md':'규정_AI_거버넌스_new.docx','가이드라인_AI_거버넌스.md':'가이드라인_AI_거버넌스_new.docx'};

(async () => {
  for (const f of FILES) {
    const outName = (typeof OUT_NAMES !== 'undefined' && OUT_NAMES[f]) || f.replace('.md','.docx');
